      ...
      <Layout>
        <div className="background grid auto-cols-max justify-center sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="hidden sm:flex flex-col justify-center bg-white m-10 rounded-3xl h-5/6 shadow-2xl lg:mt-36 
            ...
            <div className="sm:mt-20 sm:mx-10 md:text-md lg:text-lg 2xl:text-xl text-center mb-3 font-bold text-gray-700">
          ...
          <div className="hidden sm:flex flex-col justify-center bg-white m-10 rounded-3xl h-5/6 shadow-2xl lg:mt-36 
            ...
            <div className="sm:mt-20 sm:mx-10 md:text-sm lg:text-lg 2xl:text-xl text-center mb-3 font-bold text-gray-700">
