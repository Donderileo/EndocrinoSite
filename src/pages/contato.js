          ...
          <div className="mt-28">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 mt-5 2xl:grid-cols-4 2xl:mt-20">
              ...
              <div className="2xl:col-start-2 flex flex-col justify-center items-center text-center">
                ...
                <p className=" mt-5 text-xl text-gray-900">Localizado na Rua Guaipá, 51 Conjunto 303</p>
                <p className="text-lg text-gray-900">São Paulo-SP</p>

                <p className="mt-5 text-xl text-wrap text-gray-900 ">Contamos com uma excelente estrutura física e profissionais preparados para sanar suas dúvidas, venha fazer uma consulta conosco.</p>
              ...
              <div className="flex flex-col justify-center items-center text-center mr-10">
