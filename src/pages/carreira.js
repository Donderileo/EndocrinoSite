      ...
      <Layout>
        <div className="mt-28">
          ...
          <div className="mt-10 sm:mt-5 grid grid-cols-1 sm:grid-cols-2 gap-6 mx-10">
            ...
            <div className="bg-white rounded-xl shadow-xl transform duration-200  hover:-translate-y-2 border-transparent border-2 hover:border-roxo">
              <img className="absolute  left-0 w-14 h-14 md:w-28 md:h-28 rounded-full" src="/images/logo-santos.jpg" alt="logo universidade de santos" />
              <p className="mt-5 text-roxo font-black text-center text-6xl ">1998</p>
            ...
            <div className="bg-white rounded-xl shadow-xl transform duration-200 border-transparent border-2 hover:border-roxo hover:-translate-y-2">

              <img className="left-2 top-2 absolute w-12 h-12 md:w-24 md:h-24 " src="images/SBEM.png" alt="Logo SBEM" />

              <p className="mt-5 text-roxo font-black text-center text-6xl ">2003</p>
            ...
            <div className="bg-white rounded-xl shadow-xl transform duration-200 border-transparent border-2 hover:border-roxo hover:-translate-y-2">
              ...
              <img className="absolute w-14 h-14 md:w-28 md:h-28 rounded-full" src="/images/medusp.png" alt="Logo USP Medicina" />

              <p className="mt-5 text-roxo font-black text-center text-6xl ">2008</p>
            ...
            <div className="bg-white rounded-xl shadow-xl transform duration-200 hover:-translate-y-2 border-transparent border-2 hover:border-roxo">
              ...
              <img className="absolute w-14 h-14 md:w-28 md:h-28 " src="/images/pucsp.jpg" alt="Logo PUCSP" />
              <p className="mt-5 text-roxo font-black text-center text-6xl">Hoje</p>
