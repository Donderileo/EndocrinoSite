    ...
    <div>
      <Layout>
        <div className="mt-36  ">
          ...
          <div className="mt-10 sm:mt-5 grid grid-cols-1 xl:grid-cols-2 gap-6 mx-10">

            <div className="flex flex-col items-center bg-white rounded-xl shadow-xl transform duration-200  hover:-translate-y-2 border-transparent border-4 hover:border-roxo">

              <img className="xl:absolute mt-5 left-3 top-3 w-14 h-14 md:w-28 md:h-28 rounded-full" src="/images/logo-santos.jpg" alt="logo universidade de santos" />
            ...
            <div className="flex flex-col items-center bg-white rounded-xl shadow-xl transform duration-200 border-transparent border-4 hover:border-roxo hover:-translate-y-2">

              <img className="xl:absolute mt-5 left-3 top-3 w-12 h-12 md:w-24 md:h-24 " src="/images/SBEM.png" alt="Logo SBEM" />
            ...
            <div className="flex flex-col items-center bg-white rounded-xl shadow-xl transform duration-200 border-transparent border-4 hover:border-roxo hover:-translate-y-2">
              ...
              <img className="xl:absolute mt-5  left-3 top-3 w-14 h-14 md:w-28 md:h-28 rounded-full" src="/images/medusp.png" alt="Logo USP Medicina" />
            ...
            <div className="flex flex-col items-center bg-white rounded-xl shadow-xl transform duration-200 hover:-translate-y-2 border-transparent border-4 hover:border-roxo">
              ...
              <img className="xl:absolute mt-5  left-3 top-3 w-14 h-14 md:w-28 md:h-28 " src="/images/pucsp.jpg" alt="Logo PUCSP" />
